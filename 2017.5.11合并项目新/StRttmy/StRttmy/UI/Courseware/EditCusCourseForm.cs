...
{
    public partial class EditCusCourseForm : Form
    {
        ...
        private void EditCusCourseForm_Load(object sender, EventArgs e)
        {
        ...
        //窗体激活
        private void EditCusCourseForm_Activated(object sender, EventArgs e)
        {
            txtName.Focus();
        ...
        private void EditCourse()
        {
            if (Program.mf.LoginUser != null)
            {
                ...
                if (tempc != null && tempc.CoursewareId.Equals(coursewareId))
                {
                ...
                if (coursewareId != Guid.Empty)
                {
                   ...
                   // newCourseware.CoursewareLevelId = Guid.Parse("73bea99c-ab04-46ad-8df3-8ecbb0dffe7c");
                    ...
                    if (cb.EditCusCourse(newCourseware))
                    {
