...
{
    public partial class PubCourseListForm : Form
    {
        ...
        private void PubCourseListForm_Load(object sender, EventArgs e)
        {
            ...
            ShowCourseList(txtKeyword.Text, Guid.Parse("b6c51980-f0c2-4ce1-90d5-d8fc726e0e3b"), categorystr, levelstr, subjects, TypeOfWork, SystemType);
            txtKeyword.Focus();
        }
        ...
        private void SetDgv(int ListLenght)
        {
            ...
            dgvCourseList.Columns[3].Width = 400;
            dgvCourseList.Columns[4].HeaderText = "课件名称";
            dgvCourseList.Columns[4].Width =ListLenght > 23 ? 270 : 290;
            dgvCourseList.Columns[5].HeaderText = "课件名称";
            ...
            dgvCourseList.Columns[9].HeaderText = "课件名字";
            dgvCourseList.Columns[10].HeaderText = "课件关键字";
            dgvCourseList.Columns[11].HeaderText = "课件内容";
            ...
            dgvCourseList.Columns.Insert(dgvCourseList.Columns.Count, dgvButtonColEditRes);
        ...
        private void dgvCourseList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex != -1)
            {
                ...
                {
                    UI.EditPubCourseForm pcf = new EditPubCourseForm();//修改课件信息
                    pcf.coursewareId = (Guid)dgvCourseList.Rows[e.RowIndex].Cells["CoursewareId"].Value;
                    pcf.pclf = this;
                    pcf.ShowDialog();
                }
